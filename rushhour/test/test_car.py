...
car1 = Car.new(length=2, start=Position.new(0, 0), horizontal=True)
car2 = Car.new(Position.new(0, 0), False, 2)
car3 = Car.new(Position.new(0, 0), True, 3)
car4 = Car.new(Position.new(0, 0), False, 3)
...
car_invalid = Car.new(Position.new(5, 5), True, 2)
...
car5 = Car.new(Position.new(4, 4), True, 2)

test10 = car1.no_clash(car2) == False

print("car can clash " + str(test10))

car6 = Car.new(Position.new(2, 0), True, 2)

test11 = car1.no_clash(car6) == True

print("car cannot clash " + str(test11))

car10 = Car.new(Position.new(0, 0), True, 2)
car11 = Car.new(Position.new(2, 0), True, 2)
car12 = Car.new(Position.new(4, 0), True, 2)
car13 = Car.new(Position.new(0, 1), True, 2)

test12 = car13.next_cars([car13, car10, car11, car12])

print("car can move freely", str(len(test12) == 4))

car14 = Car.new(Position.new(2, 1), True, 2)
...
print("car can be equal " + str(
    Car.new(Position.new(0, 0), True, 2) == Car.new(Position.new(0, 0), True, 2)))
