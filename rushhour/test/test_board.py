...
board1 = Board(6, 6, [Car.new(Position.new(0, 0), True, 2)], Position.new(5, 2))
test12 = board1.is_winner() == False

print("board can be no winner " + str(test12))

board2 = Board(6, 6, [Car.new(Position.new(0, 0), True, 2)], Position.new(5, 2))
board3 = Board(6, 6, [Car.new(Position.new(0, 1), True, 2), Car.new(Position.new(2,2), True, 3)], Position.new(5, 2))
